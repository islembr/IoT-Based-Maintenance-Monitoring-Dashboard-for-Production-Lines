...
import { ProjectPlannerComponent } from './pages/project-planner/project-planner.component';
...
@Component({
  ...
  imports: [CommonModule, AccueilComponent, KpiChaineComponent, ActionMaintenanceComponent, SuiviMaintenanceComponent, PlanHebdomadaireComponent, ProjectPlannerComponent, InsertionInterventionComponent, NombreInterventionsComponent, FabriqueServiceComponent, ResponsabiliteComponent, PiecesRechangeComponent],
...
export class AppComponent {
  ...
  readonly tabs: Tab[] = [
    ...
    { id: 'kpi', label: 'KPI par chaîne', icon: '▥' },
    { id: 'actions', label: 'Actions', icon: '⚙' },
    { id: 'suivi', label: 'Suivi annuel', icon: '◫' },
    { id: 'plan', label: 'Plan hebdomadaire', icon: '▦' },
    { id: 'planner', label: 'Project Planner', icon: '▤' },
    { id: 'insertion', label: 'Interventions', icon: '↻' },
    { id: 'nombre', label: 'Statistiques', icon: '↗' },
    { id: 'fabrique', label: 'Parc innovation', icon: '▤' },
    { id: 'responsabilite', label: 'Responsabilité', icon: '✓' },
    { id: 'pieces', label: 'Pièces de rechange', icon: '◇' }
  ];
  active = 'accueil';
  menuOpen = false;
  setActive(id: string): void { this.active = id; this.menuOpen = false; }
